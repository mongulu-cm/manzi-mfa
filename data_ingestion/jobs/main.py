    ...
    if csv_file:
        ...
        for config in urls_config:
            ...
            if scraper_type == ScraperType.PAGINATION:
                ...
                execute_scraper(url, scraper_type, x, y)
            else:
                execute_scraper(url, scraper_type)
    else:
        ...
        execute_scraper(url, scraper_type, x_pos, y_pos)

def execute_scraper(url: str, scraper_type: ScraperType, x: Optional[int] = None, y: Optional[int] = None):
    """
